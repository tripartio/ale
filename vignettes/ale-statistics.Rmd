...
mb_gam_math$ale$boot$distinct$math_avg$stats[[1]]$by_term$public
```
...
mb_gam_math$ale$boot$distinct$math_avg$stats[[1]]$by_term$academic_ratio
```
...
mb_gam_math$ale$boot$distinct$math_avg$stats[[1]]$by_term$rand_norm
```
...
mb_gam_math$ale$boot$distinct$math_avg$stats[[1]]$by_term$mean_ses
```
...
mb_gam_math$ale$boot$distinct$math_avg$stats[[1]]$conf_regions$by_term$mean_ses |> 
...
mb_gam_math$ale$boot$distinct$math_avg$stats[[1]]$conf_regions$by_term$public
```
...
mb_gam_math$ale$boot$distinct$math_avg$stats[[1]]$conf_regions$by_term$rand_norm
```
...
mb_gam_math$ale$boot$distinct$math_avg$stats[[1]]$conf_regions$significant
```
...
mb_gam_math$ale$boot$distinct$math_avg$stats[[1]]$conf_regions$significant$term |> 
  unique()
```
