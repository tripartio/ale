...
mb_gam_1D_plots <- mb_gam_plots$distinct$math_avg$plots$d1
...
mb_no_p_1D_plots <- mb_no_p_plots$distinct$math_avg$plots$d1
...
mb_gam_math_stats <- mb_gam_math$ale$boot$distinct$math_avg$stats$d1
```
...
mb_gam_plots@distinct$math_avg$eff_plot
...
mb_gam_math$ale$boot$distinct$math_avg$ale$d1$public
```
...
mb_gam_math$ale$boot$distinct$math_avg$ale$d1$academic_ratio
```
