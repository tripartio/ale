...
The [`ALEPlot` package](https://cran.r-project.org/web/packages/ALEPlot/) is the reference implementation of the brilliant idea of [accumulated local effects (ALE) by Daniel Apley and Jingyu Zhu](https://www.doi.org/10.1111/rssb.12377). However, it has not been updated since 2018. Thus, The `ale` package attempts to rewrite and extend the original base work.
...
```{r ALEPlot nnet organized plots, fig.asp=4}
