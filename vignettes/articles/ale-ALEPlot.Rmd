...
nn_ale_ixn$plots |>
  ...
  purrr::walk(\(.x1) {  
    ...
    patchwork::wrap_plots(.x1, ncol = 2, nrow = 2) |> 
      print()
  })
```
...
#   pred_fun = yhat,
#   max_x_int = 500,
#   rug_sample_size = 600,  # technical issue: rug_sample_size must be > max_x_int + 1
...
gbm_ale_ixn_link[["plots"]][["age"]][["education_num"]]
```
