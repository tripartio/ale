...
gbm_1D_link_plots <- gbm_link_plots$distinct$y$plots[[1]]
...
gbm_link_2D_plots <- gbm_link_plots$distinct$y$plots[[2]]
gbm_link_2D_plots |>
  # extract list of x1 ALE outputs
  purrr::walk(\(it.x1) {  
    # plot all x2 plots in each .x1 element
...
gbm_2D_prob_plots <- gbm_prob_plots$distinct$y$plots[[2]]
patchwork::wrap_plots(gbm_2D_prob_plots, ncol = 2)
```
...
gbm_prob_2D_plots <- gbm_prob_plots$distinct$y$plots[[2]]
gbm_prob_2D_plots |>
  # extract list of x1 ALE outputs
  purrr::walk(\(it.x1) {  
    # plot all x2 plots in each .x1 element
