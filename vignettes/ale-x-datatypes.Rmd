...
```{r gam_cars}
gam_cars <- mgcv::gam(mpg ~ cyl + disp + hp + drat + wt + s(qsec) +
...
# Warnings are because it is difficult to bootstrap such a small dataset.
# However, most bootstrap iterations succeed nonetheless.
