...
# Print all plots
cars_plots <- plot(cars_ale)
cars_1D_plots <- cars_plots$distinct$mpg$plots$d1
patchwork::wrap_plots(cars_1D_plots, ncol = 2)
```
...
```{r cars_ale_2D, fig.width=7, fig.height=7}
cars_ale_2D <- ALE(
  var_cars, cars_gam,
  complete_d = 2,
  parallel = 2  # CRAN limit (delete this line on your own computer)
...
# Print plots
cars_2D_plots <- plot(cars_ale_2D)
cars_2D_plots <- cars_2D_plots$distinct$mpg$plots$d2
cars_2D_plots |>
...
patchwork::wrap_plots(mb_1D_plots, ncol = 2)
```
