...
By default, most core functions in the `{ale}` package use parallel processing. If your computer has problems with this, you can disable parallelization with the global option  `options(ale.parallel = 0)` or the argument `parallel = 0` in specific functions like `ALE()`.
