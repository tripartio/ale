...
- **Chitu Okoli**. Author, maintainer.
  [](https://orcid.org/0000-0001-5574-7572)

## Citation

Source:
[`inst/CITATION`](https://github.com/tripartio/ale/blob/main/inst/CITATION)
...
from Accumulated Local Effects (ALE).” Conference,
<https://sites.google.com/view/data-science-2024/program>.

    @Unpublished{alestatsinformsds,
      note = {Conference},
      author = {Chitu Okoli},
