...
```{r simple-ale, eval=FALSE, echo=TRUE, fig.width=7, fig.height=11}
# Create ALE data
...
```{r simple-ale-rds, eval=TRUE, echo=FALSE, fig.width=7, fig.height=11}
# Create ALE data
...
```{r p_values, eval=FALSE, echo=TRUE}
...
```{r p_values-rds, eval=TRUE, echo=FALSE}
# Create p_value distribution object
...
```{r ale-p-rds, eval=TRUE, echo=FALSE}
# Create ALE data with p-values
...
```{r ale-1D-plot, fig.width=7, fig.height=11}
