...
---
    ...
    Output
      ...
      # A tibble: 2 x 7
        ...
        <ord>  <int> <dbl> <dbl>   <dbl>     <dbl> <dbl>
      1 FALSE     38 -1.52 -4.95   -1.52   -0.664  0.458
      2 TRUE      26  1.10 -3.06    1.10   -0.0313 7.17 
      
      attr(,"effect")$mpg$ale$d1$model
      # A tibble: 32 x 7
         model.bin             .n       .y     .y_lo  .y_mean .y_median  .y_hi
         <ord>              <int>    <dbl>     <dbl>    <dbl>     <dbl>  <dbl>
       1 AMC Javelin            2 -13.7    -17.9     -13.7      -14.6   -7.98 
       2 Cadillac Fleetwood     2 -16.9    -27.7     -16.9      -15.6   -8.05 
       3 Camaro Z28             2  -5.03   -20.5      -5.03      -0.326  2.45 
       4 Chrysler Imperial      2  -4.08   -10.4      -4.08      -3.06   0.457
       5 Datsun 710             2   0.0490  -1.92      0.0490    -1.32   4.35 
       6 Dodge Challenger       2   8.86     3.88      8.86       6.80  17.3  
       7 Duster 360             2   4.82    -3.05      4.82       2.73  16.3  
       8 Ferrari Dino           2   6.92    -0.00527   6.92       7.63  12.7  
       9 Fiat 128               2   8.17     0.123     8.17       8.67  15.4  
      10 Fiat X1-9              2  -1.95    -9.37     -1.95      -1.75   5.11 
      # i 22 more rows
      ...
      # A tibble: 3 x 7
        ...
        <ord>    <int>  <dbl> <dbl>   <dbl>     <dbl>  <dbl>
      1 three       30 -0.590 -2.46  -0.590   -0.0556  0.377
      2 four        24  2.97   2.09   2.97     2.76    4.22 
      3 five        10 -2.17  -2.74  -2.17    -2.08   -1.74 
